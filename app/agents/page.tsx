    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="mx-auto max-w-7xl px-4 py-6 sm:py-8 md:px-8">
        ...
        <div className="mb-6 border border-border bg-card p-3 sm:p-4">
          ...
          {/* Search + skill pills — same line, search shortened */}
          <div className="mb-3 flex flex-wrap items-center gap-2">
            <div className="relative shrink-0">
              <svg className="absolute left-2.5 top-1/2 h-4 w-4 -translate-y-1/2 text-muted" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <input
                ...
                className="w-48 min-w-0 rounded-lg border border-border bg-background py-2 pl-8 pr-2.5 text-sm text-foreground placeholder:text-muted focus:border-orange/50 focus:outline-none focus:ring-1 focus:ring-orange/30 sm:w-56"
              />
            </div>
